    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".product-main-slider")) {
                let mainProdSlider = new swiper_core_Swiper(".product-main-slider", {
            ...
            if (document.querySelector(".product-card__slider")) {
                ...
                sliders.forEach((slider => {
                    ...
                    function updateFraction(slider) {
                        ...
                        popagination.querySelectorAll(".swiper-pagination-bullet").forEach(((el, index) => {
                            el.style.setProperty("--element-width", width + "%");
                            el.style.setProperty("--element-position", width * index + "%");
